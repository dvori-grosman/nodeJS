...
function HeroBackgroundDecorations() {
  const sparklePositions = [
    ...
    { top: '80%', right: '45%', delay: '0s' },
    { top: '60%', left: '10%', delay: '1s' },
    { bottom: '90%', left: '20%', delay: '1.5s' }
  ];
...
function HeroContent({ logoUrl }) {
  const welcomeMessages = [
    "בית ספר חרדי ללימוד מחול, התעמלות קרקע, אקרודאנס ובלט קלאסי, הכל באווירה שמורה ואיכותית...",
...
function WelcomeTitle() {
  return (
    <h1 className="text-4xl md:text-5xl font-bold mb-6 gold-text" style={{ fontSize: '6rem' }}>
      ריקוד ברוח הטובה
    </h1>
  );
}
