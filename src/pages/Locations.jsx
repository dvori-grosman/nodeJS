...
export default function LocationsPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch branches
        const branchesResponse = await fetch('https://dance-studio-server.onrender.com/api/branches');
        const branchesData = await branchesResponse.json();
        
        // Fetch schedule
        const scheduleResponse = await fetch('https://dance-studio-server.onrender.com/api/classes/schedule');
  ...
  const fetchBranchSchedule = async (branchId) => {
    try {
      const response = await fetch(`https://dance-studio-server.onrender.com/api/classes/schedule?branch=${branchId}`);
